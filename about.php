            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="about-details mb-50">
                        <p class="pear1">We believe that every project existing in digital world is a result of an idea
                            and every idea has a cause. </p>
                        <p class="pear2">Amet, consectetur adipisicing elit, sed dosmod tempor didunt ut labore et dolor
                            dfagna iqus ad minim veniam quis. sectetur adipisicing eld do eiusmod tempor didunt ut
                            labore et dolore magna aliqus ad minim.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="about-tittle">
